         ...
         <form method="post">
            <div class="form-row">
                ...
                <label for="inputEmail4">Nombre</label>
                    <input type="text" class="form-control" name="nombre" placeholder="ingrese Nombre Del Profesor" required>
                </div>
              ...
              <label for="inputEmail4">Profesión</label>
                    <input type="text" class="form-control" name="profesion" placeholder="ingrese Profesión Del Profesor" required>
                </div>
            <button type="submit" class="btn btn-primary">Guardar</button>
            <?php
            $action = new ControladorProfesores();
